...
1. Los tiempos de respuesta máximo obtenidos durante las pruebas de rendimiento se enmarcan dentro generalemente aceptado para aplicaciones empresariales y del sector de la insustria fintech (no superan los 5 segundos en máxima carga). Esto incluye a transacciones complejas de $APP como las del servicio de Órdenes. Pag. 14, _Informe Técnico_
