...
| Sistema de Mensajes | Capability | Esta solución de interoperabilidad usa un sistema de mensajes de petición, respuesta y excepción.  |
...
> Integraciones JEP, 2024  Integración JEP. Softgic. Ambientes y Herramientas. Organización de referencia.   versión 0.1.21  

<br>

Organización de referencia de los ambientes de trabajo JEP.

![04.ING.3n.2. Ambientes y Herramientas. _Fuente: Repositorio arquitectura Integración JEP (2024)_](images/04.ING.3n.2.AmbientesyHerramientas.png){#fig:id-53af0cb1d4e145a6b82764f7ce8f9237 width=}
...
Table: Elementos de la vista. {#tbl:tblelement-04.ING.3n.2.AmbientesyHerramientas-id}
